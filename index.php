...
<section class="latest-works">
  <div class="container">
    ...
    <ul class="work-filters">
      <li class="active" data-filter="podcast">PODCAST</li>
    ...
    <div class="portfolio-grid zoom-gallery">
      ...
      <div class="portfolio-item podcast">
        <iframe src="https://www.youtube.com/embed/zNjHhsOqQt8" allowfullscreen></iframe>
      </div>
      <div class="portfolio-item podcast">
        <iframe src="https://www.youtube.com/embed/yY2OLz3zCdI" allowfullscreen></iframe>
      </div>
      <div class="portfolio-item podcast">
        <iframe src="https://www.youtube.com/embed/SQH7BpFzRR0" allowfullscreen></iframe>
      </div>
      <div class="portfolio-item podcast">
        <iframe src="https://www.youtube.com/embed/A1WGFjX7XN0" allowfullscreen></iframe>
      </div>
      <div class="portfolio-item podcast">
        <iframe src="https://www.youtube.com/embed/Ka8HZAwdNu4" allowfullscreen></iframe>
      </div>
      <div class="portfolio-item podcast">
        <iframe src="https://www.youtube.com/embed/apuFi-EL2WA" allowfullscreen></iframe>
      </div>
      <div class="portfolio-item podcast">
        <iframe src="https://www.youtube.com/embed/T-AyGoQjc8k" allowfullscreen></iframe>
      </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const formHead = document.getElementById("contactFormHead");
  const loaderHead = document.getElementById("loaderHead");
  const formContainerHead = document.getElementById("form-container-head");

  if (!formHead) return; // safety check

  formHead.addEventListener("submit", function (e) {
    e.preventDefault();

    if (!formHead.checkValidity()) {
      formHead.classList.add("was-validated");
      return;
    }

    formContainerHead.style.display = "none";
    loaderHead.style.display = "block";

    const formDataHead = new FormData(formHead);
    ...
    .catch(error => {
      loaderHead.style.display = "none";
      formContainerHead.style.display = "block";
      alert("Something went wrong. Please try again.");
      console.error(error);
    });
  });
...
<script>
document.addEventListener("DOMContentLoaded", function () {
  const filterButtons = document.querySelectorAll(".work-filters li");
  ...
  let activeFilter = "podcast";
  let visibleCount = isMobile ? 2 : 8;

  function initPopup() {
    $(grid).magnificPopup("destroy");

    $(grid).magnificPopup({
      delegate: '.portfolio-item:not([style*="display: none"]) a',
      type: 'image',
      gallery: {
        enabled: true
      },
