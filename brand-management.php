...
<div class="container-fluid header-to">
  <img src="assets/img/services/brand manage.jpg" alt="" class="c-img  d-lg-block d-none">
...
<!-- why Choose start -->
<div class="container-fluid ser-back mt-5" style="background-color:#032539;">
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-lg-6 dm-ser" data-aos="fade-up" data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000">
        <img src="assets/img/gif/brand-manage.gif" alt="" class="w-100 " />
      </div>
...
<div class="conatiner-fluid">
  <div class="container">
    <div class="row">
      <ul class="ser-li">
        <li><span> Brand Development Strategy - </span> a clear vision, mission, and values that define the brand's essence and guide its direction.</li>
        <li><span>
            Market Research and Analysis - </span> consumer preferences, market trends, and competitor strategies to inform brand decisions.</li>
        <li><span>
            Brand Identity Design - </span> visual elements such as logos, color schemes, and typography that covers the brand's personality and values.</li>
        <li><span>
            Brand Positioning and Messaging - </span> compelling narratives and communication strategies to convey the brand's unique value proposition.
        </li>
        <li><span>Brand Communication and Marketing - </span> marketers develop integrated communication plans to effectively reach and engage target audiences through various channels, including advertising, social media, public relations, and content marketing. They craft compelling brand messages and stories that capture the essence of the brand and resonate with consumers on an emotional level.</li>
        <li><span> Brand Experience Design and Management - </span> experience (UX) designers and customer experience (CX) experts focus on creating smooth and memorable brand experiences across all devices, from websites and mobile apps to physical stores and packaging. They test usability and gather feedback to continuously improve the brand experience and drive customer satisfaction and loyalty. Ensuring consistency across from advertising and packaging to customer service to deliver a cohesive brand experience.</li>

        <li><span> Brand Reputation Management and Monitoring - </span> online and offline channels for feedback and sentiment, and addressing any issues that may arise to protect the brand's image. </li>
      </ul>
    </div>
  </div>
</div>
