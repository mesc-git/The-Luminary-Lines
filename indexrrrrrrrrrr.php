    ...
    <div class="partner">
      <div class="partner__wapper">
        <div class="partner__content">
          ...
          <div class="slide2">
            <img src="assets/img/clients/NSDC.png" alt="" class="partner__logo2" />
          </div>
          <div class="slide2">
            <img src="assets/img/clients/indiaskillshigh.png" alt="" class="partner__logo2" />
          </div>
          <div class="slide2">
            <img src="assets/img/clients/vidyadaan.png" alt="" class="partner__logo2" />
          </div>
          <div class="slide">
            <img src="assets/img/clients/MECAT-Logo .png" alt="" class="partner__logo" />
          </div>
          <!-- <div class="slide">
            <img src="assets/img/about/Frame_13.svg" alt="" class="partner__logo" />
          </div>
          <div class="slide">
            <img src="assets/img/about/Frame_14.svg" alt="" class="partner__logo" />
          </div>
          <div class="slide">
            <img src="assets/img/about/Frame_15.svg" alt="" class="partner__logo" />
          </div>
          <div class="slide">
            <img src="assets/img/about/Frame_16.svg" alt="" class="partner__logo" />
          </div> -->
        </div>
      </div>
    </div>
        ...
        <form class="row g-3 needs-validation" method="post" action="process_form.php" novalidate>
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" id="project_type" name="project_type" required>
              ...
              <option value="Content-Creation">Consulting</option>
              <option value="Website Development">Media and Promotion</option>
