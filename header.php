...
<body>
      ...
      <div class="container">
        ...
        <p>
          ...
          <div class="d-flex align-items-center header__top_contact">
            <p class="email">info@theluminarylines.com</p>
            <span class="line"></span>
            <p class="phone">+91 9871845696</p>
            <span class="line"></span>
            <ul class="d-flex align-items-center icons">
              <li><a href="https://www.facebook.com/theluminarylines
            "><i class="fa-brands fa-facebook-f"></i></a></li>
              <li><a href="https://twitter.com/_luminarylines"><i class="fa-brands fa-x-twitter"></i></a></li>
              <li><a href="https://www.instagram.com/_luminarylines/"><i class="fa-brands fa-instagram"></i></a></li>
              <li><a href="https://www.linkedin.com/company/luminarylines/"><i class="fa-brands fa-linkedin"></i></a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-lg-12 col-12">
              <div class="get-form " id="form-container-head">
                <form id="contactFormHead" class="row g-3 needs-validation" novalidate>
  ...
  <!-- LOADER -->
  <div id="loaderHead" style="display:none; text-align:center; margin-top:20px;">
...
<!-- THANK YOU MESSAGE -->
<!-- <div id="thank-you-message-head" style="display:none; text-align:center;">
  <h3>Thank you!</h3>
