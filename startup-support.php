...
<div class="container-fluid header-to">
  <img src="assets/img/consulting/startup.jpg" alt="" class="c-img  d-lg-block d-none">
...
<article class="service__details ">
  <div class="container ">
    ...
    <div class="first__para pt__60">
      ...
      <p>
        In the competitive world of startups, where innovation meets uncertainty, having a trusted advisor can make all the difference between success and failure. Our startup consulting services help your business journey from ideation to market entry and beyond.
      </p>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 col-lg-6 dm-title" data-aos="fade-up" data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000">
        ...
        <p class="text-light" style="font-size: 24px;">
...
<div class="conatiner-fluid">
  <div class="container">
    <div class="row">
      <ul class="ser-li">
        <li><span>Ideation and Business Planning - </span> Every successful startup begins with a compelling idea, but it takes careful planning to turn that idea into reality. Our experts work closely with aspiring entrepreneurs to refine their concepts, develop strong business models, and craft actionable business plans. By conducting thorough market research and practicability studies, we help startups lay the foundation for sustainable growth.</li>
        <li><span>
            Market Analysis - </span> In today’s competitive landscape, understanding the market is the most important for startup success. Our consultants leverage their industry expertise and analytical skills to conduct in-depth market analysis. From identifying target demographics to assessing competitive landscapes, we equip startups with invaluable insights to make informed strategic decisions.</li>

        <li><span>Funding Strategies - </span> Securing adequate funding is often a significant hurdle for startups. Our consulting services include guidance on funding strategies that are specific to each startup’s unique needs and goals. Whether it’s navigating the details of investment, venture capital, or crowdfunding, we assist startups in accessing the capital they need to fuel their growth ambitions.</li>

        <li><span> Scalability - </span> As startups gain traction and expand their operations, scalability becomes a critical factor. Our consultants provide scalable solutions that enable startups to efficiently manage growth while maintaining agility and adaptability. Whether it’s optimizing internal processes, expanding into new markets, or scaling up production, we help startups chart a course for sustainable scalability.</li>

        <li><span> Navigating Challenges and Seizing Opportunities </span> The entrepreneurial journey is filled with challenges and uncertainties. From regulatory compliance issues to operational delay or failure, startups face a lot of obstacles along the way. Our consulting team acts as a trusted partner, offering guidance and support to navigate challenges effectively. Moreover, we help startups identify and capitalize on emerging opportunities, ensuring they stay ahead of the curve in today’s rapidly evolving business landscape.</li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-12 dm-title" data-aos="fade-up" data-aos-delay="100" data-aos-offset="0" data-aos-duration="1000">
        ...
        <p class="text-light">
          In conclusion, startup consulting services play a huge role in helping your business grow and succeed when there are a lot of uncertainties. At Luminary Lines, we are committed to supporting startups at every stage of their journey, from ideation to market entry and beyond. With our comprehensive suite of services and seasoned expertise, we enable startups to overcome obstacles, capitalize on opportunities, and achieve sustainable growth.
        </p>
      </div>
    </div>
  </div>
